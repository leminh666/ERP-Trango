...
export class IncomeCategoriesController {
  ...
  @Get()
  @ApiOperation({ summary: 'Lấy danh sách danh mục thu' })
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Lấy thông tin danh mục thu' })
  async findOne(@Param('id') id: string) {
    return this.service.findOne(id);
  }

  @Post()
  @ApiOperation({ summary: 'Tạo danh mục thu mới' })
  async create(
  ...
  @Put(':id')
  @ApiOperation({ summary: 'Cập nhật danh mục thu' })
  async update(
    @Param('id') id: string,
    @Body() data: { name?: string; visualType?: string; iconKey?: string; imageUrl?: string; color?: string },
    @Request() req?: { user: { id: string; email?: string } },
  ...
  @Delete(':id')
  @ApiOperation({ summary: 'Xóa danh mục thu (soft delete)' })
  async delete(
    @Param('id') id: string,
    @Request() req?: { user: { id: string; email?: string } },
  ) {
  ...
  @Post(':id/restore')
  @ApiOperation({ summary: 'Khôi phục danh mục thu' })
  async restore(
    @Param('id') id: string,
    @Request() req?: { user: { id: string; email?: string } },
  ) {
  ...
  @Get(':id/usage')
  @ApiOperation({ summary: 'Xem danh sách giao dịch đã dùng danh mục thu' })
